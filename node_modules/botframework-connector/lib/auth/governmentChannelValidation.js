...
(function (GovernmentChannelValidation) {
    ...
    function authenticateChannelToken(authHeader, credentials, channelId) {
        return __awaiter(this, void 0, void 0, function* () {
            const tokenExtractor = new jwtTokenExtractor_1.JwtTokenExtractor(GovernmentChannelValidation.ToBotFromGovernmentChannelTokenValidationParameters, channelValidation_1.ChannelValidation.OpenIdMetadataEndpoint ? channelValidation_1.ChannelValidation.OpenIdMetadataEndpoint : governmentConstants_1.GovernmentConstants.ToBotFromChannelOpenIdMetadataUrl, constants_1.Constants.AllowedSigningAlgorithms);
    ...
    */
    function validateIdentity(identity, credentials) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (identity.getClaimValue(constants_1.Constants.IssuerClaim) !== governmentConstants_1.GovernmentConstants.ToBotFromChannelTokenIssuer) {
